...
back.
C customers have bought tickets that allow them to sit in a specific seat.
1 customer may buy more than 1 ticket. There are M tickets in total.
You may choose to put (promote) a customer into a seat in front of their
assigned seat. This is called a promotion.
...
// We read the test case from standard input, and return a pair of vector<int>s
